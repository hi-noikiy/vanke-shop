...
//        }
    ...
    public function buyStep3($post, $member_id) {
        ...
        //发送兑换码到手机
        $param = array('order_id'=>$order_info['order_id'],'buyer_id'=>$member_id,'buyer_phone'=>$order_info['buyer_phone'],'goods_name'=>$order_info['goods_name'],'goods_num'=> $order_info['goods_num'], 'store_name'=>$order_info['store_name']);
    ...
    private function _createOrder($input, $goods_info, $member_info) {
        ...
        $order['inviter_store'] = $member_info['inviter_store'];   //cary_add 推荐店铺ID
    ...
    private function _rcbPay($order_info, $input, $buyer_info) {
        ...
        //$param = array('order_id'=>$order_info['order_id'],'buyer_id'=>$order_info['buyer_id'],'buyer_phone'=>$order_info['buyer_phone']);
          $param = array('order_id'=>$order_info['order_id'],'buyer_id'=>$order_info['buyer_id'],'buyer_phone'=>$order_info['buyer_phone'],'goods_name'=>$order_info['goods_name'],'goods_num'=> $order_info['goods_num'], 'store_name'=>$order_info['store_name']);
