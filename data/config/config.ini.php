...
$config['tablepre']		= 'sc_';
$config['db']['1']['dbhost']       = 'rds5f3gzemdw53bpsnowl.mysql.rds.aliyuncs.com';//'127.0.0.1';//'10.39.35.16';
$config['db']['1']['dbport']       = '3306';
$config['db']['1']['dbuser']       = 'purtest';//'root';
$config['db']['1']['dbpwd']        = 'tX1fm5Mk3';//'zgyyxm1314';
$config['db']['1']['dbname']       = 'vs_purchase_t1';//'vs_purchase_t1';//'wk_line_c';
