    ...
    private function _formatMbSpecialData($item_data, $item_type) {
        switch ($item_type) {
            ...
            case 'home5':
                ...
                $item_data['rectangle1_image'] = getMbSpecialImageUrl($item_data['rectangle1_image']);
                $item_data['rectangle2_image'] = getMbSpecialImageUrl($item_data['rectangle2_image']);
                $item_data['bottom1_image'] = getMbSpecialImageUrl($item_data['bottom1_image']);
                $item_data['bottom2_image'] = getMbSpecialImageUrl($item_data['bottom2_image']);
                $item_data['bottom3_image'] = getMbSpecialImageUrl($item_data['bottom3_image']);
                break;
            case 'goods':
	                 //
			  case 'goods1':
