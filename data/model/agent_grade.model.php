...
//		}
		...
		if ($condition['sg_id'] != ''){
			$condition_str .= " and agent_grade.sg_id = '". $condition['sg_id'] ."'";
		}
		/*if($condition['agent_id'] != '') {
			$condition_str .= " and agent.agent_id=".$condition['agent_id'];
		}*/
...
//		}
	...
	public function add($param){
		...
		if (is_array($param)){
			...
			$result = Db::insert('agent_grade',$tmp);
			return $result;
		}else {
			return false;
		}
	...
	public function update($param){
		...
		if (is_array($param)){
			...
			$result = Db::update('agent_grade',$tmp,$where);
			return $result;
		}else {
			return false;
		}
	...
	public function del($id){
		if (intval($id) > 0){
			...
			$result = Db::delete('agent_grade',$where);
			return $result;
		}else {
			return false;
		}
