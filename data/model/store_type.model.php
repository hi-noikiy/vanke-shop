...
class store_typeModel extends Model {

    public function __construct(){
        parent::__construct('store_type');
    }
     ...
     * @param string $order
     */
    public function getStoreClassList($condition = array(), $pagesize = '', $limit = '', $order = 'st_sort asc,st_id asc') {
