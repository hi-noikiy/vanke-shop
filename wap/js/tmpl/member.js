    ...
    if (a) {
        $.ajax({
            ...
            success: function(a) {
                ...
                $(".member-top").html(e);
                var e = '<li><a href="order_list.html?data-state=state_new">' + (a.datas.member_info.order_nopay_count > 0 ? "<em></em>": "") + '<i class="cc-01"></i><p>待付款</p></a></li>' +  '<li><a href="order_list.html?data-state=state_sendstat">' + (a.datas.member_info.order_notakes_count > 0 ? "<em></em>": "") + '<i class="cc-03"></i><p>待发货</p></a></li>' + '<li><a href="order_list.html?data-state=state_send">' + (a.datas.member_info.order_noreceipt_count > 0 ? "<em></em>": "") + '<i class="cc-02"></i><p>待收货</p></a></li>' +'<li><a href="order_list.html?data-state=state_noeval">' + (a.datas.member_info.order_noeval_count > 0 ? "<em></em>": "") + '<i class="cc-04"></i><p>待评价</p></a></li>' + '<li><a href="member_refund.html">' + (a.datas.member_info.
                return > 0 ? "<em></em>": "") + '<i class="cc-05"></i><p>退款/退货</p></a></li>';
                $("#order_ul").html(e);
                var e = '<li><a href="predepositlog_list.html"><i class="cc-06"></i><p>预存款</p></a></li>' + '<li><a href="rechargecardlog_list.html"><i class="cc-07"></i><p>充值卡</p></a></li>' + '<li><a href="voucher_list.html"><i class="cc-08"></i><p>代金券</p></a></li>'  + '<li><a href="pointslog_list.html"><i class="cc-10"></i><p>积分</p></a></li>'; //+ '<li><a href="redpacket_list.html"><i class="cc-09"></i><p>红包</p></a></li>'
                $("#asset_ul").html(e);
                if(getCookie("has_store") ==1){
                    var e = '<dt><a href="../seller/login.html"><h3><i class="mc-03"></i>我的店铺</h3><h5><i class="arrow-r"></i></h5></a></dt>';
                    $("#seller_menu").html(e);
                }
                return false
            }
