                ...
                $.each(v, function(kk, vv) {
                    switch (kk) {
                        ...
                        case 'home5':
                            ...
                            vv.rectangle1_url = buildUrl(vv.rectangle1_type, vv.rectangle1_data);
                            vv.rectangle2_url = buildUrl(vv.rectangle2_type, vv.rectangle2_data);
                            vv.bottom1_url = buildUrl(vv.bottom1_type, vv.bottom1_data);
                            vv.bottom2_url = buildUrl(vv.bottom2_type, vv.bottom2_data);
                            vv.bottom3_url = buildUrl(vv.bottom3_type, vv.bottom3_data);
                            break;
                    }
                    if (k == 0) {
