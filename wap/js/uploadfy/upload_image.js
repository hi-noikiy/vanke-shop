...
//						console.log(picUrl);
						img[0].onload = function() {
							...
							//context.$uploadBtn.before('<input type="hidden" name="' + context.config.inputName + '[' + index + ']" class="' + imageName + '" value="' + picUrl + '">')
                                                        context.$uploadBtn.before('<input type="hidden" name="upload_yinyeimg" class="' + imageName + '" value="' + picUrl + '">')
                                                        context.$uploadBtn.before('<img style="width:15%" src="'+ResourUrl+'/data/upload/shop/store_joinin/'+picUrl+'">');
						...
						img[0].src = ResourUrl+'/data/upload/shop/store_joinin/'+picUrl;
					},
					error: function() {
