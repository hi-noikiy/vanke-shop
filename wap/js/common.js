...
$(function(){
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.php?act=index&op=is_third_post",
        data: {},
        dataType: "json",
        success: function(e) {
            ...
            if(e.code == 1){
                //不是第三方用户跳转至第三方认证
                if(window.location.href != WapSiteUrl + "/tmpl/third_post.html"){
                    window.location.href= WapSiteUrl + "/tmpl/third_post.html";
                }
            }
        }
    })
