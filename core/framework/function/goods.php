...
function orderState($order_info) {
    switch ($order_info['order_state']) {
        ...
        case ORDER_WAIT_CANCEL:
            $order_state = L('order_wait_cancel');
        break;
        ...
        break;
        case ORDER_DELIVER_GOODS:
            $order_state = L('deliver_audit');
        break;
        case ORDER_STATUS_SEND_TWO:
            $order_state = L('pending_audit');
        break;
        case ORDER_STATUS_SEND_ONE:
            $order_state = L('order_audit');
        break;
        case ORDER_STATUS_SUCCESS:
            $order_state = L('acceptance_audit'); 
        break;
        case ORDER_STATUS_ERROR:
            $order_state = L('audit_return');
        break;
        case ORDER_STATUS_OUT:
            $order_state = L('audit_reject'); 
        break;
        case ORDER_STATUS_CUS_RECEIVED:
            $order_state = L('audit_issend');
        break;
        case ORDER_STATUS_SEND_HET:
            $order_state = L('audit_instat');
        break;
    }
    return $order_state;
}
...
function orderStates($order_info) {
    switch ($order_info['order_state']) {
        case ORDER_STATE_CANCEL:
            $order_state = L('order_state_cancel');
        break;
        case ORDER_STATUS_SEND_HET:
            $order_state = L('audit_insend');
        break;
        case ORDER_WAIT_CANCEL:
            $order_state = L('order_wait_cancel');
        break;
