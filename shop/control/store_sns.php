...
class store_snsControl extends BaseSellerControl{
	...
	public function settingOp(){
		...
		$sauto_info	= $model_storesnssetting->getStoreSnsSettingInfo(array('sauto_storeid' =>$_SESSION['store_id'])); //@cary_fix 修复设置不能保存的问题
		...
		if(chksubmit()){
			...
			if($sauto_info){
				$result = $model_storesnssetting->updateStoreSnsSetting($update,array('sauto_storeid' => $_SESSION['store_id']));
			}else{
