...
class member_goodsbrowseControl extends BaseMemberControl{
    ...
    public function listOp(){
        ...
        if ($browselist){
            $goods_list_tmp = Model('goods')->getGoodsList(array('goods_id' => array('in', array_keys($browselist))), 'goods_id, goods_name, goods_promotion_price,goods_promotion_type, goods_marketprice, goods_image, store_id, gc_id, gc_id_1, gc_id_2, gc_id_3,goods_price,g_costprice');
            $goods_list = array();
