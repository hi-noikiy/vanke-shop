...
class agent_loginControl extends BaseAgentControl {
...
//        Tpl::setLayout('agent_layout');
        ...
        if (!empty($_SESSION['agent_id'])) {
            @header('location: index.php?act=agent_center');die;
        }
	}
...
//                $_SESSION['grade_id'] = $store_info['grade_id'];
                ...
                $_SESSION['agent_id'] = $seller_info['seller_id'];
...
//                }
                ...
                $seller_menu = $this->getSellerMenuList($seller_info['is_admin'], explode(',', ''));
...
//                $this->recordSellerLog('登录成功');
                redirect('index.php?act=agent_center');
            } else {
