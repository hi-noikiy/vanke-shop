...
//                array("input"=>$_POST["region"],"require"=>"true","message"=>$lang['store_daddress_area_null']),
                array("input"=>$_POST["area_info"],"require"=>"true","message"=>$lang['store_daddress_area_null']), // cary_add
...
//                'area_info' => $_POST['region'],
                'area_info' => $_POST['area_info'],  //@cary edit
   ...
   public function daddress_default_setOp() {
    ...
    public function free_freightOp(){
		...
		$store_free_time = $_POST['store_free_time'];
	        ...
	        $model_store->editStore(array('store_free_price'=>$store_free_price,'store_free_time'=>$store_free_time,'freight'=>$freight),array('store_id'=>$_SESSION['store_id']));
	        showDialog(L('nc_common_save_succ'),'','succ');
	    }
            $freight=$model_store->field('freight')->where(array('store_id'=>$_SESSION['store_id']))->find();

            Tpl::output('freight',$freight['freight']);
