...
//             //添加店铺评价
            ...
            if ($state){
                ...
                $data['log_user'] = $order_info['buyer_name'];
            ...
            if($order_info['order_lei'] == '2'){
                showDialog(Language::get('member_evaluation_evaluat_success'),'index.php?act=member_inorder&op=inside_order', 'succ');
            }else{
                showDialog(Language::get('member_evaluation_evaluat_success'),'index.php?act=member_order_third', 'succ');
            }
