...
class member_orderControl extends BaseMemberControl {
    ...
    private function _order_cancel($order_info, $post) {
        if (!chksubmit()) {
            ...
            if($order_info['order_state'] == ORDER_STATUS_SUCCESS || $order_info['order_state'] == ORDER_DELIVER_GOODS){
                return $logic_order->changeExamineOrderStateCancel($order_info,'buyer', $_SESSION['member_name'], $msg);
            }else{
