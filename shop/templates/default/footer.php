...
<div class="help">
    ...
    <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$GLOBALS['setting_config']['site_logowx']; ?>" class="f-l jImg img-error">
        				...
        				<div class="weibo f-l" style="display: none;">
...
<!--  <p><a href="<?php echo SHOP_SITE_URL;?>"><?php echo $lang['nc_index'];?></a>
    ...
    <?php }?>
     ...
     <?php echo html_entity_decode($output['setting_config']['statistics_code'],ENT_QUOTES); ?><br/><?php echo $output['setting_config']['icp_number']; ?>
    -->
    <!--  增加物业标签 -->
    <p>
        版权 万科物业发展有限公司所有
        <br>
       <a target="_blank" href="http://www.miitbeian.gov.cn" >粤ICP备15063920号-2</a>
    </p>
