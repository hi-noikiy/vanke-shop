...
<div class="header">
  ...
  <ul class="header_menu">
    <li class="<?php echo $output['show_sign']=='joinin' ? 'current':'';?>"><a href="<?php echo urlShop('show_joinin', 'index2');?>" class="joinin"><i></i>供应商认证申请</a></li>
    <li class="<?php echo $output['show_sign']=='join' ? 'current':'';?>"><a href="<?php echo urlShop('show_join', 'index');?>" class="joinin"><i></i>供应商入驻申请</a></li>
    <li class=""><a href="<?php echo urlShop('seller_center', 'index');?>" class="login"><i></i>供应商管理中心</a></li>
    <li class="<?php echo $output['show_sign']=='help' ? 'current':'';?>"><a href="<?php echo urlShop('show_help', 'index');?>" class="faq"><i></i>供应商帮助指南</a></li>
  </ul>
</div>
