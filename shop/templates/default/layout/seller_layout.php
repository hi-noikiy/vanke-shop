  ...
  <div class="wrapper">
    ...
    <nav class="ncsc-nav">
      <dl class="<?php echo $output['current_menu']['model'] == 'index'?'current':'';?>">
        <dt><a href="<?php echo urlShop('seller_center', 'index');?>">首页</a></dt>
        <dd class="arrow"></dd>
      </dl>
...
<div id="tbox">
    ...
    <div class="btn" id="2msg"><a href="javascript:void(0)" nc_type="dialog" dialog_title="基本信息申请" dialog_id="my_goods_brand_apply" dialog_width="480" uri="index.php?act=attribute_add&op=brand_add"><i class="im"><em id="new_msg" style="display:none;"></em></i>信息申请</a></div>
