...
<div class="category">
  <ul class="menu whk_<?php echo $output['index_sign']; ?> ">
    <?php $menu_sub_array = array('',' ','','','','','',''); ?>
    ...
    <li cat_id="<?php echo $val['gc_id'];?>" class="<?php echo $i%2==1 ? 'odd':'even';?>" <?php if($i>14){?>style="display:none;"<?php }?>>
      ...
      <span class="arrow"></span>
        ...
        <?php } ?>
              ...
              <?php } ?>
              <p ><?php echo $menu_sub_array[$i]; ?><?php //if (!empty($val['cn_classs']) && is_array($val['cn_classs'])) {
               // foreach ($val['cn_classs'] as $k => $v) {   echo '<a href="'.urlShop('search','index',array('cate_id'=> $v['gc_id'])).'">'.$v['gc_name'].'</a> ';  } } ?></p>
         </div>
    ...
    <li cat_id="662" class="odd" style="display: none"></li>
  </ul>
</div>
