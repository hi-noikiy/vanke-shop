...
<header class="ncsc-head-layout w">
  <div class="wrapper">
    <div class="ncsc-admin">
      ...
      <div class="ncsc-admin-function"><a href="<?php echo urlShop('member_security', 'auth',array('type'=>'modify_pwd'));?>" title="修改密码" target="_blank"><i class="icon-wrench"></i></a><a href="<?php echo urlShop('agent_logout', 'logout');;?>" title="安全退出"><i class="icon-signout"></i></a></div>
    </div>
    ...
    <nav class="ncsc-nav">
      <dl class="<?php echo $output['current_menu']['model'] == 'index'?'current':'';?>">
        <dt><a href="<?php echo urlShop('agent_center', 'index');?>">首页</a></dt>
        <dd class="arrow"></dd>
      </dl>
      ...
      <dl class="<?php echo $output['current_menu']['model'] == $key?'current':'';?>">
        <dt><a href="<?php echo urlShop($menu_value['child'][key($menu_value['child'])]['act'], $menu_value['child'][key($menu_value['child'])]['op']);?>"><?php echo $menu_value['name'];?></a></dt>
        <dd>
          <ul>
            <?php if(!empty($menu_value['child']) && is_array($menu_value['child'])) {?>
            <?php foreach($menu_value['child'] as $submenu_value) {?>
            <li> <a href="<?php echo urlShop($submenu_value['act'], $submenu_value['op']);?>"> <?php echo $submenu_value['name'];?> </a> </li>
            <?php } ?>
            <?php } ?>
          </ul>
        </dd>
...
<div class="ncsc-layout wrapper">
    ...
    <div id="sidebar" class="sidebar">
      ...
      <div class="column-menu">
        <ul id="seller_center_left_menu">
          ...
          <li <?php echo $_GET['act'] == 'seller_center'?"id='quicklink_".$submenu_value['act']."'":'';?>class="<?php echo $submenu_value['act'] == $_GET['act']?'current':'';?>"> <a href="<?php echo urlShop($submenu_value['act'], $submenu_value['op']);?>"> <?php echo $submenu_value['name'];?> </a> </li>
          <?php } ?>
          <?php } else { ?>
  ...
  <div id="layoutRight" class="ncsc-layout-right">
    <div class="ncsc-path"><i class="icon-desktop"></i>代理后台<i class="icon-angle-right"></i><?php echo $output['current_menu']['model_name'];?><i class="icon-angle-right"></i><?php echo $output['current_menu']['name'];?></div>
