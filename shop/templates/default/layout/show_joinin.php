  ...
  <div class="user-box">
		  <?php if($_SESSION['is_login'] == '1'){?>
			<div class="user-joinin">
				  ...
				  <div class="bottom"><a href="<?php echo urlShop('store_joinin','step0');?>" target="_blank">我要开店</a><a href="<?php echo urlShop('store_joinin','index');?>" target="_blank">查看开店进度</a></div>
			</div>
		  <?php }else{?>
