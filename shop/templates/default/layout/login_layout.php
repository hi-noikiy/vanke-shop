...
<div class="header-wrap">
  <header class="public-head-layout wrapper">
    ...
    <span>您好，欢迎来到<?php echo $output['setting_config']['site_name']; ?><br/><?php echo $lang['login_index_regist_now_1'];?><a title="" href="<?php echo urlShop('login', 'register','');?>" class="register"><?php echo $lang['login_index_regist_now_2'];?></a></span></div>
    <?php } else {?>
    <div class="nc-login-now"><?php echo $lang['login_register_login_now_1'];?><a href="<?php echo urlShop('login', 'index','');?>" title="<?php echo $lang['login_register_login_now'];?>" class="register"><?php echo $lang['login_register_login_now_2'];?></a></span></div>
    <?php }?>
    <?php }?>
  </header>
</div>
