...
<div class="item-publish">
  <form method="post" id="goods_form" action="index.php?act=store_goods_add&op=save_goods_data">
    ...
    <div class="ncsc-form-goods">
      ...
      <dl nctype="virtual_null">
        ...
        <?php foreach ($output['city_store_list'] as $city_key=>$city_vl){?>
        	...
        	<td width="33%"><label><input <?php if($city_vl['city_center'] == '1'){?>class="city_conters"<?php }?> name="city_center[]" type="checkbox" value="<?php echo $city_vl['city_center'];?>" />&nbsp;&nbsp;<?php echo $city_vl['city_name'];?> </label> </td>
        	<?php if($city_key%3 == 2){?></tr><?php }?>
         <?php }?>
         </table>
         <input id="city_center_id" name="city_center_id" type="hidden" value="" />
         <span></span>
          	<p class="hint"></p>
        </dd>
      </dl>
