...
<div class="bottom">
  ...
  <label <?php if(intval($output['complain_info']['complain_state']) >= 40){?>style='display:none;'<?php } ?>class="submit-border"> <a id="btn_handle" class="submit"><?php echo $lang['handle_submit'];?></a> </label>
</div>
<?php } ?>
