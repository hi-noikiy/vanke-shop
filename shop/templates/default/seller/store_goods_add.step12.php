  ...
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
    ...
    <div class="ncsc-form-goods">
      ...
      <dl>
        ...
        <dd nc_type="no_spec">
          <input pctype="pice_num" name="g_marketprice" value="<?php echo $output['goods']['goods_marketprice']; ?>" type="text" class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
      ...
      <dl>
        ...
        <dd nc_type="no_spec">
          <input pctype="pice_num" name="g_price" value="<?php echo $output['goods']['goods_price']; ?>" type="text"  class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
        ...
        <dd>
          <input pctype="pice_num" name="goods_third_price" value="<?php echo $output['goods']['goods_third_price']; ?>" type="text" class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
      ...
      <dl>
        ...
        <dd>
          <input pctype="pice_num" name="g_costprice" value="<?php echo $output['goods']['goods_costprice']; ?>" type="text" class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
      ...
      <dl>
        ...
        <dd nc_type="no_spec">
          <input name="g_storage" value="<?php if($output['goods']['g_storage']){echo $output['goods']['g_storage'];}else{echo 99999;}?>" type="text" class="text w60"
	  ...
	  <dl>
        <dt><i class="required">*</i>最小购买数量<?php echo $lang['nc_colon'];?></dt>
        <dd>
          <input name="min_num" value="<?php if($output['goods']['min_num']){echo $output['goods']['min_num'];}else{echo 1;}?>" type="text" class="text w60"
                 onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" />
          <span></span>
	  ...
	  <dl>
        <dt><i class="required">*</i>最大购买数量<?php echo $lang['nc_colon'];?></dt>
        <dd>
          <input name="max_num" value="<?php if($output['goods']['max_num']){echo $output['goods']['max_num'];}else{echo 99999;}?>" type="text" class="text w60"
                 onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" />
          <span></span>
...
//                }
            ...
            .find('input[data_type="g_costprice"]').change(function(){
                computegcosprice();     // 价格计算
            }).end()
            .find('input[data_type="marketprice"]').change(function(){
                computemarkPrice();
            }).end()
//            .find('input[data_type="goods_toc_price"]').change(function(){
//                computetocprice();     // 价格计算
//            }).end()
            .find('input[data_type="goods_third_price"]').change(function(){
                computethrprice();     // 价格计算
            }).end()
