...
<div class="eject_con">
  <div id="warning"></div>
  <form method="post" id="order_cancel_form" onsubmit="ajaxpost('order_cancel_form', '', '', 'onerror');return false;" action="index.php?act=store_transport_nei&op=refuseOrder&order_id=<?php echo $output['order_id']; ?>">
    ...
    <dl>
        <dt>买家取消订单原因</dt>
        <dd><span class="num"><?php echo $output['order_login']; ?></span></dd>
    </dl>
    ...
    <dl>
      ...
      <dd>
        <ul class="checked">
          ...
          <li>
            <input type="radio" checked="checked" name="state_info" id="d3" value="<?php echo $lang['store_order_buy_apply'];?>"/>
