...
<i class="icon-renminbi"></i>
        ...
        <p class="hint">默认为 0，表示不设置免运费额度，大于0表示购买金额超出该值后将免运费</p>
            ...
            <dt>运费价格<?php echo $lang['nc_colon'];?></dt>
      <dd>
        <input class="text w60" name="freight" maxlength="10" type="text"  id="freight" value="<?php echo $output['freight'];?>" /><em class="add-on">
<i class="icon-renminbi"></i>
</em>
        <p class="hint">默认为 0，表示运费为0，大于0表示低于免费额度后收取的运费</p>
      </dd>
