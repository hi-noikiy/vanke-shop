<?php ?>
<?php
$store_id = base64_encode(intval($_SESSION['store_id'])*1);
?>
    ...
    <div class="basic-info">
      <dl class="ncsc-seller-info">
        <dt class="seller-name">
          ...
          <h5>(用户名：<?php echo $_SESSION['member_name']; ?>) &nbsp;&nbsp;<button id="opener" >推广链接</button> </h5>
        </dt>
        <dd class="store-logo">
...
<?php } ?>
  ...
  <div class="seller-cont">
    ...
    <div class="container type-d h500" style="display: none;">
      <div class="hd">
...
$(function(){
  ...
  $( "#opener" ).click(function() {
    showDialog('注册链接：<input id="siUrl" style="width:250px;" value="<?php echo BASE_SITE_URL;?>/#ST<?php echo  $store_id;?>" onclick="$(this).select();" /><br/><br/>1.通过该链接注册的会员，即自动为您的店铺会员<br/>2.您可以享受店铺用户在本商城消费的利润抽成。','notice','店铺会员注册');
  });
