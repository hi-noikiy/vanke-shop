...
<?php if($output['order_info']['order_lei'] != '1'){?>
<span class="fr mr5"> <a class="ncsc-btn-mini" href="javascript:void(0)" nc_type="dialog" dialog_title="订单拆分" dialog_id="my_goods_brand_apply2" dialog_width="800" uri="index.php?act=store_deliver&op=send_order_open&order_id=<?php echo $_GET['order_id'];?>"><i class="icon-print"></i>订单拆分</a></span>
<?php }?>
...
<div class="wrap">
  ...
  <form name="deliver_form" method="POST" id="deliver_form" action="index.php?act=store_deliver&op=send&order_id=<?php echo $_GET['order_id'];?>" onsubmit="ajaxpost('deliver_form', '', '', 'onerror');return false;">
    ...
    <div class="deliver-sell-info"><strong class="fl"><?php echo $lang['store_deliver_my_daddress'].$lang['nc_colon'];?></strong>
      <a href="javascript:void(0);" onclick="select_list()" class="ncsc-btn-mini fr"><i class="icon-edit"></i><?php echo $lang['nc_edit'];?></a> <span id="seller_address_span">
...
<script type="text/javascript">
    ...
    function edit_data(address_id,address_name,address_phone,address_city,address_value){
        $('#daddress_id').val(address_id);
        $('#seller_address_span').html(address_name+"&nbsp;&nbsp;"+address_phone+"&nbsp;&nbsp;"+address_city+"&nbsp;&nbsp;"+address_value);
