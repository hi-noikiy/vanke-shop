...
<div class="ncsc-oredr-show">
  <div class="ncsc-order-info">
    <div class="ncsc-order-details" style="width:50%">
      ...
      <div class="content">
        <dl>
          ...
          <dt></dt><dd><?php echo @$output['order_info']['extend_order_common']['reciver_info']['phone'];?></dd>   
          <dt></dt><dd><?php echo @$output['order_info']['extend_order_common']['reciver_info']['address'];?><?php echo $output['order_info']['extend_order_common']['reciver_info']['dlyp'] ? '[自提服务站]' : '';?></dd>
        </dl>
        <dl>
          <dt>发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票：</dt>
          <dd>
    ...
    <?php } ?>
    <?php if ($output['order_info']['order_state'] == ORDER_STATUS_SEND_HET) { ?>
    <div class="ncsc-order-condition">
      <dl>
        <dt><i class="icon-ok-circle green"></i>订单状态：</dt>
        <dd>已发货</dd>
  ...
  <div id="order-step" class="ncsc-order-step">
    ...
    <dl class="<?php if(intval($output['order_info']['order_state']  >= ORDER_STATUS_SEND_TWO)) echo 'current'; ?>">
      <dt>审核中</dt>
      <dd class="bg"> </dd>
     <dd class="date" title="<?php echo $lang['store_order_add_time'];?>"><?php echo date("Y-m-d H:i:s",$output['order_info']['add_time']); ?></dd>
    </dl>
    ...
    <dl class="<?php if($output['order_info']['order_state'] >= ORDER_STATE_SEND) echo 'current'; ?>">
      <dt>已受理</dt>
      <dd class="bg"> </dd>
      <dd class="date" title="<?php echo $lang['store_show_order_acceptance_time'];?>"><?php echo date("Y-m-d H:i:s",$output['order_info']['acceptance_info']['log_time']); ?></dd>
    </dl>
      <?php }?>
	
      
    <?php if($output['order_info']['order_state'] <= ORDER_STATE_SUCCESS  && $output['order_info']['order_state'] != ORDER_STATUS_OUT){ ?>
    <dl class="<?php if($output['order_info']['order_state'] >= ORDER_STATUS_SEND_HET) echo 'current'; ?>">
      <dt>已发货</dt>
      <dd class="bg"> </dd>
      <dd class="date" title="<?php echo $lang['store_show_order_send_time'];?>"><?php echo date("Y-m-d H:i:s",$output['order_info']['extend_order_common']['shipping_time']); ?></dd>
    </dl>
  ...
  <div id="order-step" class="ncsc-order-step">
    ...
    <dl class="current">
      <dt>审核通过</dt>
      <dd class="bg"> </dd>
      <dd class="date" title="<?php echo $lang['store_show_order_sh_time'];?>"><?php echo date("Y-m-d H:i:s",$output['order_info']['add_time']); ?></dd>
    </dl>
    <dl class="current">
      <dt>取消订单</dt>
      <dd class="bg"> </dd>
      <dd class="date" title="<?php echo $lang['store_show_order_cancel_add_time'];?>"><?php echo date("Y-m-d H:i:s",$output['order_info']['clence_info']['log_time']); ?></dd>
    </dl>
    <dl class="">
          <dt>取消待通过</dt>
          <dd class="bg"> </dd>
