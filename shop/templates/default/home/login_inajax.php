...
<div class="quick-login">
  <form id="login_form" action="index.php?act=login" method="post" class="bg" >
    ...
    <dl>
      ...
      <dd>
        ...
        <img class="fl ml10" src="index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" border="0" id="codeimage" onclick="this.src='<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random()"><span></span></dd>
    </dl>
    <?php } ?>
    <ul>
    ...
    <div class="enter">
      ...
      <?php } ?>
          ...
          <span style="margin:0 0 0 15px;">
              <a href="<?php echo SHOP_SITE_URL;?>/api.php?act=towanke" title="助这儿登入" class="wanke"><i></i>助这儿</a>
      </span>
    </div>
    <input type="hidden" value="<?php echo $_GET['ref_url']?>" name="ref_url">
      <input type="hidden" name="ref_url_iframe" id="ref_url_iframe" value="<?php echo $_COOKIE['ref_url_iframe']?>">
  </form>
</div>
<script>
