			...
			<div class="user-login">
			  ...
			  <form id="login_form" action="index.php?act=login" method="post">
				...
				<dl>
				  <dt></dt>
				  <dd>
					<input type="hidden" value="<?php echo SHOP_SITE_URL;?>/index.php?act=<?php if($_GET['act']=='show_joinin'){echo "show_joinin";}else{echo "show_join";}?>" name="ref_url">
...
<div class="main mt30">
  ...
  <div class="joinin-index-step">
	...
	<span class="step"><i class="e"></i>店铺开通</span>
      -->
        <span class="step"><i class="b"></i>提交认证信息</span><span class="arrow"></span>
        <span class="step"><i class="c"></i>平台审核资质</span><span class="arrow"></span>
        <span class="step"><i class="b"></i>提交开店信息</span><span class="arrow"></span>
        <span class="step"><i class="c"></i>平台审核资质</span><span class="arrow"></span>
        <span class="step"><i class="e"></i>店铺开通</span>
   </div>
