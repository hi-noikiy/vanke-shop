...
<div class='layui-col-md3' style='width:600px;margin:0 auto;margin-top: 20px;'>
    ...
    <div class="layui-row">
        <a href="javascript:void(0);" onclick="addTender('<?php echo $output['tender_id'];?>')"
           style="text-decoration:none;margin-left: 200px;margin-top: 20px;background-color: #71b704;" class="layui-btn">立即投标</a>
        <button type="reset" onclick="cancel_all()" style="margin-top: 20px"
                class="layui-btn layui-btn-primary">取&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;消</button>
    </div>
</div>
...
<script>
    ...
    function addTender(tender_id){
        $.ajax({
            type:"POST",
            //提交的网址
            url:"/shop/index.php?act=tender&op=bidTender",
            ...
            success:function(result){
                if(result == '0'){
                    layui.use('layer', function(){
                        ...
                        layer.alert('投标成功', {closeBtn: 0,title: '温馨提示',}, function(index){
                            layer.closeAll();
                    ...
                    layui.use('layer', function(){
                        var layer = layui.layer;
                        layer.alert('投标失败', {closeBtn: 0,title: '温馨提示',}, function(index){
                            layer.closeAll();
                        });
                    })
                }
