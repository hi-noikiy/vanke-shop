...
<!--        <li class="step1 <?php echo $output['step'] >= 0 ? 'current' : '';?>"><span>签订入驻协议</span></li>
        ...
        <li class="step1 <?php echo $output['step'] >= 3 ? 'current' : '';?>"><span>店铺经营信息</span></li>
        <li class="<?php echo $output['step'] >= 4 ? 'current' : '';?>"><span>合同签订</span></li>
        <li class="step6 <?php echo $output['rzsuccess'] >= 6 ? 'current' : '';?>" ><span>店铺认证</span></li>
      </ul>
    </div>
