...
<!--            <li class=""><i></i>店铺经营信息</li>-->
      ...
      <dl>
        <dt class="<?php echo $output['step'] == '4' ? 'current' : '';?>"> <i class="hide"></i>合同签订</dt>
      </dl>
<!--      <dl>
  ...
  <div class="right-layout">
    <div class="joinin-step">
      <ul>
        <li class="step1 <?php echo $output['step'] >= 0 ? 'current' : '';?>"><span>签订认证协议</span></li>
        ...
        <li class="step5 <?php echo $output['rzsuccess'] >= 5 ? 'current' : '';?>"  ><span>待验证</span></li>
        <li class="step6 <?php echo $output['rzsuccess'] >= 6 ? 'current' : '';?>"  ><span>资质认证</span></li>
      </ul>
    </div>
