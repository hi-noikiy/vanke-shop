      ...
      <div id="tabs_container" class="tabs-container">
        ...
        <div id="mobile" class="tabs-content">
          <form id="post_form" method="post" class="nc-login-form" action="<?php echo urlLogin('connect_sms', 'find_password');?>">
            ...
            <div class="tiptext" id="sms_text">正确输入上方验证码后，点击<span > <a href="javascript:void(0);"  onclick="get_sms_captcha('3')"><i class="icon-mobile-phone"></i>发送短信验证</a></span>，查收短信将系统发送的“6位手机动态码”输入到下方验证后登录。</div>
            <dl>
              <dt>短信验证：</dt>
              <dd>
                <input type="text" name="sms_captcha" autocomplete="off" class="text " id="sms_captcha" size="15"  tipMsg="输入动态码" />
              </dd>
            </dl>
            <dl>
              <dt>新密码：</dt>
