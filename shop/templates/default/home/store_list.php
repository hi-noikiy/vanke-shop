...
.jcarousel-skin-tango .jcarousel-clip-horizontal { width: 1000px !important; height: 255px !important;}
.jcarousel-skin-tango .jcarousel-item { height: 255px !important;}
  ...
  <dl>
    ...
    <dd>
      ...
      <?php foreach($output['class_list'] as $k=>$v){?>
	      ...
	      <a href="<?php echo urlShop('store_list','index',array('cate_id'=>$v['sc_id']));?>"><?php echo $v['sc_name'];?></a>
...
<?php foreach($output['store_list'] as $skey => $store){?>
    <li class="item">
      <dl class="shop-info">
        ...
        <dd class="shopkeeper"><?php echo $lang['store_class_index_owner'].$lang['nc_colon'];?><?php echo $store['member_name'];?><a target="_blank" class="message" href="<?php echo urlShop('member_message','sendmsg', array('member_id'=>$store['member_id']),$store['store_domain']);?>"></a><span>
      ...
      <div class="nc-shop-goodslist" nc_type='goods_<?php echo $skey;?>'>
        ...
        <li>
            <dl>
              <dt class="goods-pic"><span class="thumb size160"> <i></i> <a href="<?php echo urlShop('goods','',array('goods_id'=>$v['goods_id']));?>" target="_blank"> <img  onload="javascript:DrawImage(this,160,160);" alt="<?php echo $v['goods_name'];?>" src="<?php echo thumb($v,'small');?>"></a></span></dt>
              ...
              <div style="width:155px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">城市公司：<?php if($store['store_city_name']){echo $store['store_city_name'];}?></div>
