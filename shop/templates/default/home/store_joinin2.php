  ...
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <dl>
        ...
        <dd> 若您还没有填写认证申请资料<br/>
          请点击“<a href="<?php echo urlShop('store_joinin', 'step0');?>" target="_blank">我要认证</a>”进行认证资料填写</dd>
        
        <dd>若您的店铺还未开通<br/>
          请通过“<a href="<?php echo urlShop('store_joinin', 'index');?>" target="_blank">查看认证进度</a>”了解店铺开通的最新状况 </dd>
        <dd style="margin-top:-20px;">
            <a href="<?php echo urlShop('storejoininlog', 'loocklog');?>" target="_blank">查看申请记录</a>
        </dd>
       
      </dl>
      <div class="bottom"><a href="<?php echo urlShop('store_joinin', 'step0');?>" target="_blank">我要认证</a><a href="<?php echo urlShop('store_joinin', 'index');?>" target="_blank">查看认证进度</a><a href="<?php echo urlShop('login', 'logout');?>" target="">退出</a></div>
    </div>
     <?php }else { ?>
    <div class="user-login">
      ...
      <form id="login_form" action="index.php?act=login" method="post">
        ...
        <dl>
          <dt></dt>
          <dd>
            <input type="hidden" value="<?php echo SHOP_SITE_URL?>/index.php?act=show_joinin&op=index2" name="ref_url">
...
<div class="main mt30">
  <h2 class="index-title">认证流程</h2>
  <div class="joinin-index-step">
      <span class="step"><i class="a"></i>签署认证协议</span><span class="arrow"></span>
      <span class="step"><i class="b"></i>入驻信息提交</span><span class="arrow"></span>
      <span class="step"><i class="c"></i>平台审核资质</span><span class="arrow"></span>
      <span class="step"><i class="e"></i>认证完成</span></div>
  <h2 class="index-title">认证指南</h2>
