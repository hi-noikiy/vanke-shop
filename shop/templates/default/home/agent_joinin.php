  ...
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <dl>
        ...
        <dd> 若您还没有填写申请资料<br/>
          请点击“<a href="<?php echo urlShop('agent_joinin', 'step0');?>" target="_blank">我要加盟</a>”进行个人资料填写</dd>
        <dd>若您的代理账号还未开通<br/>
          请通过“<a href="<?php echo urlShop('agent_joinin', 'index');?>" target="_blank">查看处理进度</a>”了解最新处理状况 </dd>
      </dl>
      <div class="bottom"><a href="<?php echo urlShop('agent_joinin', 'step0');?>" target="_blank">申请加盟</a><a href="<?php echo urlShop('agent_joinin', 'index');?>" target="_blank">查看处理进度</a></div>
    </div>
     <?php }else { ?>
      ...
      <form id="login_form" action="index.php?act=login" method="post">
        ...
        <dl>
          ...
          <dd>
            ...
            <img src="index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>" class="fl ml5" name="codeimage" id="codeimage" border="0" width="100px;" /></a>
            <label></label>
          </dd>
        </dl>
        <?php } ?>
        <dl>
          <dt></dt>
          <dd>
            <input type="hidden" value="<?php echo SHOP_SITE_URL?>/index.php?act=show_joinin&op=agent" name="ref_url">
...
<div class="main mt30">
  <h2 class="index-title">加盟流程</h2>
  <div class="joinin-index-step"><span class="step"><i class="a"></i>签署加盟协议</span><span class="arrow"></span><span class="step"><i class="b"></i>代理信息提交</span><span class="arrow"></span><span class="step"><i class="c"></i>平台审核资质</span><span class="arrow"></span><span class="step"><i class="d"></i>缴纳费用</span><span class="arrow"></span><span class="step"><i class="e"></i>成功加盟</span></div>
  <h2 class="index-title">加盟指南</h2>
