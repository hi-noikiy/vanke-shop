      ...
      <div class="goods-content" nctype_goods=" <?php echo $value['goods_id'];?>" nctype_store="<?php echo $value['store_id'];?>">
        ...
        <div class="goods-info">
          ...
          <div class="goods-price">
              ...
              <em class="sale-price" title="高级会员价">
                   <?php  echo ncPriceFormat($value['goods_price']);?>
              </em> 
               <?php }else{?>
              <em class="sale-price" title="<?php echo $lang['goods_class_index_store_goods_price'];?>">
                   <?php  echo ncPriceFormat($value['g_costprice']);?>
              </em> 
                                
                <?php } ?>
            <!--  <em class="market-price" title="协议价"><?php echo ncPriceFormatForList($value['g_costprice']);?>
              </em> <span class="raty" data-score="<?php echo $value['evaluation_good_star'];?>"></span> -->
          </div>
          <div style="padding: 0 10px;width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">城市公司：<?php echo $value['store_city_name'];?></div>
          <div class="goods-sub">
...
<form id="buynow_form" method="post" action="index.php" target="_blank">
