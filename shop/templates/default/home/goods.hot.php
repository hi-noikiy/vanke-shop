      ...
      <li>
        ...
        <dl class="goods-info">
          ...
          <?php if($_SESSION['identity']==MEMBER_IDENTITY_TWO){  ?>
                 <dd class="goods-price">高级会员价：<em> 
                <?php                echo ncPriceFormatForList($value['goods_price']);
                            }else{   ?>
                  <dd class="goods-price">市场价：<em>
                 <?php               echo ncPriceFormatForList($value['g_costprice']);
                            }  ?>
              </em></dd>
