...
<div class="item">
  <div class="scope">
    ...
    <ul class="goodseval">
      ...
      <li>
        <div class="user-avatar"> <a <?php if($v['geval_isanonymous'] != 1){?>href="javascript:void(0);" target="_blank" data-param="{'id':<?php echo $v['geval_frommemberid'];?>}" nctype="mcard"<?php }?>> <img src="<?php echo getMemberAvatarForID($v['geval_frommemberid']);?>"> </a> </div>
