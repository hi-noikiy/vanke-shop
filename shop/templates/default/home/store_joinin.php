  ...
  <div class="user-box">
    ...
    <div class="user-joinin">
      ...
      <dl>
        ...
        <dd> 若您还没有填写入驻申请资料<br/>
          请点击“<a href="<?php echo urlShop('store_join', 'step0');?>" target="_blank">我要入驻</a>”进行入驻资料填写</dd>
        <dd>若您的店铺还未开通<br/>
          请通过“<a href="<?php echo urlShop('store_join', 'index');?>" target="_blank">查看入驻进度</a>”了解店铺开通的最新状况 </dd>
      </dl>
      <div class="bottom"><a href="<?php echo urlShop('store_join', 'index');?>" target="_blank">我要入驻</a><a href="<?php echo urlShop('store_join', 'index');?>" target="_blank">入驻进度</a><a href="<?php echo urlShop('login', 'logout');?>" target="">退出</a></div>
    </div>
     <?php }else { ?>
      ...
      <form id="login_form" action="index.php?act=login" method="post">
        ...
        <dl>
          ...
          <dd>
            ...
            <img src="index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>" class="fl ml5" name="codeimage" id="codeimage" border="0" width="100" /></a>
            <label></label>
          </dd>
        </dl>
        <?php } ?>
        <dl>
          <dt></dt>
          <dd>
            <input type="hidden" value="<?php echo SHOP_SITE_URL?>/index.php?act=show_joinin&op=index" name="ref_url">
...
<div class="main mt30">
  ...
  <div class="joinin-index-step">
      <!--
      <span class="step"><i class="a"></i>签署认证协议</span><span class="arrow"></span>
      ...
      <span class="step"><i class="e"></i>店铺开通</span></div>
      -->
      <span class="step"><i class="a"></i>提交认证信息</span><span class="arrow"></span>
        <span class="step"><i class="b"></i>平台审核资质</span><span class="arrow"></span>
        <span class="step"><i class="c"></i>提交开店信息</span><span class="arrow"></span>
        <span class="step"><i class="d"></i>平台审核资质</span><span class="arrow"></span>
