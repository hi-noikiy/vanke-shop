...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mt10">
  ...
  <tbody>
    ...
    <tr>
      <td><a href="javascript:void(0);" target="_blank" data-param="{'id':<?php echo $sale['buyer_id'];?>}" nctype="mcard"><?php echo $sale['buyer_name'];?></a></td>
      <?php if(!empty($output['role_id']) && $output['role_id'] == 01 )  {?>
      ...
      <?php } else {?>   
        <td><em class="price">***</em> <i style="color:red;"><?php echo $output['order_type'][$sale['goods_type']];?></i></td>  
          <?php }?>
