...
<div class="comment-widget">
  ...
  <ul class="comment-list">
    ...
    <li nc_type="commentrow_<?php echo $v['scomm_id']; ?>"> <a target="_blank" href="javascript:void(0);"><img width="30" height="30" class="clogo" src="<?php if ($v['scomm_memberavatar']!='') { echo UPLOAD_SITE_URL.'/'.ATTACH_AVATAR.DS.$v['scomm_memberavatar']; } else {  echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON.DS.C('default_user_portrait'); } ?>" onload="javascript:DrawImage(this,30,30);"></a>
      <div class="detail">
        <p class="words"><a target="_blank" href="javascript:void(0);" class="name"><?php echo $v['scomm_membername'];?></a><?php echo $lang['nc_colon']; ?><?php echo parsesmiles($v['scomm_content']);?></p>
        <p class="other">
