...
<!--<a id="yhj" href="<?php echo urlShop('show_voucher', 'index', array('store_id' => $output['store_info']['store_id']));?>"><img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/store_voucher.png" /></a>-->
...
<div class="ncs-sidebar-container ncs-top-bar">
  ...
  <div class="content">
   ...
   <?php        if($_SESSION['identity']==1){
                        echo ncPriceFormat($val['goods_price']);
                    }else{
                        echo ncPriceFormat($val['g_costprice']);
                    }      
               ?>
            </dd>
