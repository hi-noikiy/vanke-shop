    ...
    <tbody>
      ...
      <tr id="cart_item_<?php echo $cart_info['cart_id'];?>" class="shop-list <?php echo ($cart_info['state'] && $cart_info['storage_state']) ? '' : 'item_disabled';?>">
        ...
        <td class="tl" <?php if ($cart_info['bl_id'] != '0') {?>colspan="2"<?php }?>><dl class="ncc-goods-info">
                <dt style='height:100%;'>
                    <input type="hidden" name="goods_data[]" value="<?php echo $cart_info['goods_id'];?>_<?php echo $cart_info['goods_num'];?>" />
                    <a lang='<?php echo $cart_info['goods_id'];?>_<?php echo $cart_info['goods_num'];?>' href="<?php echo urlShop('goods','index',array('goods_id'=>$cart_info['goods_id']));?>" target="_blank"><?php echo $cart_info['goods_name']; ?></a></dt>
      ...
      <tr>
        <td class="tr" colspan="20"><div class="ncc-store-account">
            <dl class="freight">
              <dt>运费：</dt>
              <dd><em id="eachStoreFreight_<?php echo $store_id;?>">0.0000</em><?php echo $lang['currency_zh'];?></dd>
            </dl>
            <dl>
              <dt>商品金额：</dt>
