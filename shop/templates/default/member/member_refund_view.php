    ...
    <div id="saleRefund" show_id="1">
      <div class="ncm-flow-step">
        ...
        <dl class="<?php echo $output['refund']['seller_time'] > 0 ? 'current':'';?>">
          ...
          <?php if($output['refund']['seller_state'] != 3){?>
      ...
      <h3>我的退款申请</h3>
        ...
        <dl>
          ...
          <dl>
            <dt>商城维权<?php echo $lang['nc_colon'];?></dt>
            <dd>请进入<a href="index.php?act=member_order&op=show_order&order_id=<?php echo $output['refund']['order_id']; ?>" target="_blank">订单详情页面</a>, 提交交易投诉</dd>
          </dl>
        <?php } ?>
