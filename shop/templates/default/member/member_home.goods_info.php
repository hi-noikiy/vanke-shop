<?php ?>
<div id="favoritesGoods" class="double" <?php if($_SESSION['identity'] == MEMBER_IDENTITY_THREE ) echo 'style="display: none"' ?>>
  <div class="outline">
    <div class="title">
      <h3>商品收藏</h3>
    </div>
...
<div id="favoritesStore" class="normal" <?php if($_SESSION['identity'] == MEMBER_IDENTITY_THREE ) echo 'style="display: none"' ?>>
  <div class="outline">
    <div class="title">
      <h3>店铺收藏</h3>
    </div>
