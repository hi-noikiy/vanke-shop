...
<div class="ncm-oredr-show">
  <div class="ncm-order-info">
    ...
    <?php } ?>
    <?php if ($output['order_info']['order_state'] == ORDER_STATUS_SEND_HET || $output['order_info']['order_state'] == ORDER_STATUS_CUS_RECEIVED) { ?>
    <div class="ncm-order-condition">
      <dl>
        <dt><i class="icon-ok-circle green"></i>订单状态：</dt>
        <dd>商家已发货
  ...
  <?php if($output['order_info']['order_state'] != ORDER_WAIT_CANCEL){?>
    <dl class="step-first <?php if ($output['order_info']['order_state'] >= ORDER_STATUS_SEND_ONE) echo 'current';?>">
      <dt>待审核</dt>
      <dd class="bg"></dd>
    </dl>
    <dl class="<?php if ($output['order_info']['order_state'] >= ORDER_STATUS_SEND_TWO) echo 'current';?>">
      <dt>审核中</dt>
      <dd class="bg"> </dd>
    </dl>
    
	<?php if ($output['order_info']['order_state'] <= ORDER_STATUS_SUCCESS){?>
    <dl class="<?php if($output['order_info']['order_state'] == ORDER_STATUS_SUCCESS) echo 'current'; ?>">
      <dt>待受理</dt>
      <dd class="bg"> </dd>
    </dl>
	<?php }?>
	<?php if ($output['order_info']['order_state'] == ORDER_STATUS_ERROR){?>
    <dl class="<?php if($output['order_info']['order_state'] == ORDER_STATUS_ERROR) echo 'current'; ?>">
      <dt>审核不通过</dt>
      <dd class="bg"> </dd>
    </dl>
	<?php }?>
      <?php if ($output['order_info']['order_state'] == ORDER_STATUS_OUT){?>
    <dl class="<?php if($output['order_info']['order_state'] == ORDER_STATUS_OUT) echo 'current'; ?>">
      <dt>审核拒绝</dt>
      <dd class="bg"> </dd>
    </dl>
	<?php }?>
    ...
    <dl class="<?php if($output['order_info']['order_state'] >= ACCEPTANCE_ALREADY) echo 'current'; ?>">
      <dt>待发货</dt>
      <dd class="bg"> </dd>
    </dl>
	<?php }?> 
	
    <?php if(($output['order_info']['order_state'] >= ORDER_STATE_SEND || $output['order_info']['order_state'] <= ORDER_STATE_SEND || $output['order_info']['order_state'] <= ORDER_STATUS_CUS_RECEIVED) && $output['order_info']['order_state'] != ORDER_STATUS_OUT){ ?>
    <dl class="<?php if($output['order_info']['order_state'] >= ORDER_STATE_SEND && $output['order_info']['order_state'] != ORDER_DELIVER_GOODS) echo 'current'; ?>">
      <dt>已发货</dt>
      <dd class="bg"> </dd>
    </dl>
      <?php }?>
      
       <?php if($output['order_info']['order_state'] <= ORDER_STATUS_RECEIVED && $output['order_info']['order_state'] != ORDER_STATUS_OUT){ ?>
    <dl class="<?php if($output['order_info']['order_state'] >= ORDER_STATUS_RECEIVED) echo 'current'; ?>">
      <dt>已收货</dt>
      <dd class="bg"> </dd>
    </dl>
      <?php }?>
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <td rowspan="<?php echo $output['order_info']['goods_count'];?>">
            ...
            <?php 
            if($output['order_info']['order_state'] == ORDER_STATUS_CUS_RECEIVED){
                      if ($output['order_info']['if_lock']) {
                          echo '退货中';break;
                      }   
                  }
            ?>
            ...
            <?php if (($output['order_info']['order_state'] < ORDER_STATUS_SEND_HET || $output['order_info']['order_state'] == ORDER_DELIVER_GOODS) && $output['order_info']['order_state'] != ORDER_WAIT_CANCEL) { ?>
            ...
            <a href="../../../../data/logic/trans_order.logic.php"></a>
            <?php } ?>
            
            <!-- 退款取消订单 -->
            
            
            <?php /**if ($output['order_info']['order_state'] < ORDER_STATUS_SEND_HET && $output['order_info']['order_state'] < ORDER_STATUS_SEND_HET){ ?>
            ...
            <?php if (!$order_info['if_lock'] && ($output['order_info']['order_state']==ORDER_STATUS_CUS_RECEIVED)) { ?>
