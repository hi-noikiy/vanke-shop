...
<h3><?php echo $lang['talk_detail'];?></h3>
  ...
  <dl>
    ...
    <dd>
      ...
      <label <?php if($output['complain_info']['complain_state'] >= 40){?>style='display:none;'<?php }?> class="submit-border"><input id="btn_handle" type="submit" class="submit" value="<?php echo $lang['handle_submit'];?>"></label>
    </dd>
  </dl>
