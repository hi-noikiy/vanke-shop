...
$lang['store_deliver_express_note']			= '您可以通過"發貨設置-><a href="index.php?act=store_deliver&op=express" target="_parent" >預設物流公司</a>"添加或修改常用貨運物流。自己配送的商品可切換下方<span class="red">[自己配送]</span>選項卡並操作。';
