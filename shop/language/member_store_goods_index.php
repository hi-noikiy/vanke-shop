...
$lang['store_goods_index_store_price_interval']	= '会员价必须是0.01~1000000之间的数字';
...
$lang['store_goods_index_store_price_help']		= '会员价必须是0.01~1000000之间的数字</br>若启用了库存配置，请在下方商品库存区域进行管理</br>商品规格库存表中如有价格差异，店铺价格显示为价格区间形式';
...
$lang['store_goods_index_goods_no']				= '外部物料编号';
