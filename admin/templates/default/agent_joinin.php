...
<div class="page">
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" value="agent_joinin" name="op">
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          <th><label for="store_name">代理账号</label></th>
          <td><input type="text" value="" name="seller_name" id="seller_name" class="txt"></td>
          <th><label for="owner_and_name">登录账号</label></th>
          ...
          <td><select name="grade_id">
            ...
            <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
                ...
                <a href="index.php?act=agent&op=agent_joinin" class="btns " title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
                <?php }?></td>
        </tr>
        </tbody>
    </table>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w72 align-center">
              ...
              <a href="index.php?act=agent&op=agent_joinin_detail&member_id=<?php echo $v['member_id'];?>">审核</a>
              <?php } else { ?>
              <a href="index.php?act=agent&op=agent_joinin_detail&member_id=<?php echo $v['member_id'];?>">查看</a>
              <?php } ?>
	      <!---->
               <?php if(intval($v['joinin_state'])<40) { ?>
              &nbsp;&nbsp; <a href="index.php?act=agent&op=del_join&id=<?php echo $v['member_id']?>">删除</a>
               <?php } ?>
          </td>
        </tr>
        <?php } ?>
