    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          ...
          <td class="vatop"><input type="text" name="live_link1" class="w200" value="<?php echo $output['list_setting']['live_link1']?>">  <a href="JavaScript:void(0);" class="btn delBtn" data-id="1" ><span>删除</span></a></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          ...
          <td class="vatop "><input type="text" name="live_link2" class="w200" value="<?php echo $output['list_setting']['live_link2']?>"> <a href="JavaScript:void(0);" class="btn delBtn" data-id="2" ><span>删除</span></a></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          ...
          <td class="vatop "><input type="text" name="live_link3" class="w200" value="<?php echo $output['list_setting']['live_link3']?>"> <a href="JavaScript:void(0);" class="btn delBtn" data-id="3" ><span>删除</span></a></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          ...
          <td class="vatop "><input type="text" name="live_link4" class="w200" value="<?php echo $output['list_setting']['live_link4']?>"> <a href="JavaScript:void(0);" class="btn delBtn" data-id="4" ><span>删除</span></a></td>
        </tr>
      </tbody>
      <tfoot>
        <tr>
...
//        alert(id);
        if (!confirm('确认清空虚拟抢购幻灯片'+id+'设置？')) {
            return false;
        }
        $.ajax({
            type:'post',
            url:'index.php?act=groupbuy&op=slider_singleClear&num='+id,
            dataType:'json',
