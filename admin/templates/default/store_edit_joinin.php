...
<div class="page">
  <div class="fixed-bar">
	...
	<li><a href="index.php?act=store&op=store_joinin2"  ><span>认证申请审核</span></a></li>
        ...
        <li><a href="JavaScript:void(0);" class="current" ><span>修改供应商审核</span></a></li>
  ...
  <form method="get" name="formSearch">
    <input type="hidden" value="store_edit" name="act">
        ...
        <tr>
          ...
          <td><select name="grade_id">
            ...
            <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
                ...
                <a href="index.php?act=store_edit&op=store_joinin" class="btns " title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
                <?php }?></td>
        </tr>
        </tbody>
    </table>
...
<!--          <td class="align-center"><?php echo $v['sg_name'];?></td>-->
          ...
          <td class="w72 align-center">
              ...
              <a href="index.php?act=store_edit&op=store_joinin_detail&is_rz=1&member_id=<?php echo $v['member_id'];?>&city=<?php echo $v['city_center'];?>">审核</a>
              <?php } else { ?>
              <a href="index.php?act=store_edit&op=store_joinin_detail&member_id=<?php echo $v['member_id'];?>&city=<?php echo $v['city_center'];?>">查看</a>
              <?php } ?>
               <?php if(intval($v['joinin_state'])<40) { ?>
              &nbsp;&nbsp; <a href="index.php?act=store_edit&op=del_join&id=<?php echo $v['member_id']?>&city=<?php echo $v['city_center'];?>&city=<?php echo $v['city_center'];?>">删除</a>
               <?php } ?>
          </td>
        </tr>
        <?php } ?>
