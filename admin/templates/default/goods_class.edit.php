  ...
  <form id="goods_class_form" name="goodsClassForm" enctype="multipart/form-data" method="post">
	...
	<tr>
        ...
        <tr class="noborder">
         ...
         <tr>
          <td colspan="2" class="required"><label class="validation" for="gc_sort">商品分类Code:</label></td>
        </tr>
        <tr class="noborder">
             <td class="vatop rowform"><?php echo $output['class_array']['gc_class_code'];?></td>
          <td class="vatop rowform"><input style="display:none" type="text" value="<?php echo $output['class_array']['gc_class_code'];?>" name="class_code" id="gc_sort" class="txt"></td>
