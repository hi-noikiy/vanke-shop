    ...
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo urlAdmin('goods', 'goods', array('type' => 'waitverify'));?>"><span>上架等待审核</span></a></li>
         <li><a href="JavaScript:void(0);" class="current"><span>下架审核</span></a></li>
      </ul>
    </div>
  </div>
        ...
        function(){
            ...
            if (_div.html() == '') {
                $.getJSON('index.php?act=goods&op=get_goods_list_ajax' , {commonid : _commonid}, function(date){
                    ...
                    <div class="goods-thumb" title="商家货号：' + o.goods_serial + '"><a href="' + o.url + '" target="_blank"><image src="' + o.goods_image + '" ></a></div>' + o.goods_spec + '<div class="goods-price">外部物料编号：<br/><em style="width:100px;" title="' + o.goods_serial + '">' + o.goods_serial + '</em></div><div class="goods-price">会员价：<em style="width:70px;" title="￥' + o.goods_price + '">￥' + o.goods_price + '</em></div><div class="goods-price">协议价：<em style="width:70px;" title="￥' + o.goods_marketprice + '">￥' + o.goods_marketprice + '</em></div><div class="goods-price">市场价：<em style="width:70px;" title="￥' + o.g_costprice + '">￥' + o.g_costprice + '</em></div><div class="goods-price">最小量：<em title="' + o.min_num + '">' + o.min_num + '</em></div><div class="goods-storage">库存：<em title="' + o.goods_storage + '">' + o.goods_storage + '</em></div><a href="' + o.url + '" target="_blank" class="ncsc-btn-mini">查看商品详情</a></li>').appendTo(_ul);
                        });
                        _ul.appendTo(_div);
                        _parenttr.next().show();
                        // 计算div的宽度
                        _div.css('width', document.body.clientWidth-30);
...
function goods_verify(ids) {
    _uri = "<?php echo ADMIN_SITE_URL;?>/index.php?act=goods&op=goods_off&id=" + ids;
    CUR_DIALOG = ajax_form('goods_off', '商品下架审核', _uri, 1000);
}
</script>
<script type="text/javascript">
$(function(){
