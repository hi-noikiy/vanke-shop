  ...
  <form id="grade_form" method="post">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr>
            <td colspan="2" class="required"><label class="validation" for="sg_sort"><?php echo $lang['grade_sortname']; //级别?>:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
            <td class="vatop rowform"><input type="text" id="ag_rate" name="ag_rate" class="txt" value="<?php echo $output['grade_array']['ag_rate'];?>"></td>
