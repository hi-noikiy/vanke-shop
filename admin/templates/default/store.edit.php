  ...
  <div class="homepage-focus" nctype="editStoreContent">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="sc_id" id="sc_id">
              <option value="0"><?php echo $lang['nc_please_choose'];?>...</option>
              <?php if(is_array($output['class_list'])){ ?>
              <?php foreach($output['class_list'] as $k => $v){ ?>
              <option <?php if($output['store_array']['sc_id'] == $v['sc_id']){ ?>selected="selected"<?php } ?> value="<?php echo $v['sc_id']; ?>"  data-bind="<?php echo $v['gc_bind'];?>"><?php echo $v['sc_name']; ?></option>
              <?php } ?>
              <?php } ?>
            </select>
              <input id="gc_bind" name="gc_bind" type="hidden" value="" />
              <input id="old_sc_id" name="old_sc_id" type="hidden" value="<?php echo $output['store_array']['sc_id']; ?>" /></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
      <tbody>
      ...
      <tr class="noborder">
        ...
        <tr>
          <td colspan="2" class="required"><label>
            <label for="grade_id"> 店铺类型: </label>
            </label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><select id="st_id" name="st_id">
              <?php if(is_array($output['store_type_list'])){ ?>
              <?php foreach($output['store_type_list'] as $k => $v){ ?>
              <option <?php if($output['store_array']['store_type_id'] == $v['st_id']){ ?>selected="selected"<?php } ?> value="<?php echo $v['st_id']; ?>"><?php echo $v['st_name']; ?></option>
              <?php } ?>
              <?php } ?>
            </select><input id="st_name" name="st_name" type="hidden" /><input id="old_st_id" name="old_st_id" type="hidden" value="<?php echo $output['store_array']['store_type_id']; ?>" /></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
