  ...
  <form id="pur_form" method="post">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <!--增加字段：制度适用人员-->
        <tr>
          <td colspan="2" class="required"><label class="validation"><?php echo "制度适用人员";?>: </label></td>
        </tr>
         <tr class="noborder">
...
{   
    ...
    var newImg = '<tr id="' + file_data.file_id + '" class="tatr2"><input type="hidden" name="file_id[]" value="' + file_data.file_id + '" /><td>' + file_data.file_name + '</td><td><a href="javascript:del_file_upload(' + file_data.file_id +','+ file_data.item_id+');"><?php echo $lang['nc_del'];?></a></td></tr>';
