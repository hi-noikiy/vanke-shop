...
<!--        <li><a href="index.php?act=store&op=store_bind_class_applay_list" ><span>经营类目申请</span></a></li>-->
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <tr>
        <th>营业执照<br />电子版：</th>
        <td colspan="20"><?php if($output['joinin_detail']['business_licence_number_electronic']){?><a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_electronic']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_electronic']);?>" alt="" /> </a><?php }?></td>
      </tr>
    </tbody>
  </table>
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td colspan="20"><?php if($output['joinin_detail']['bank_licence_electronic']){?><a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['bank_licence_electronic']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['bank_licence_electronic']);?>" alt="" /> </a><?php }?></td>
      </tr>
    </tbody>
...
电子版：</th>
  ...
  <form id="form_store_verify" action="index.php?act=store_edit&op=store_joinin_verify" method="post" enctype="multipart/form-data" >
