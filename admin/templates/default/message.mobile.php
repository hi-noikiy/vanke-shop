      ...
      <tbody>
       <tr class="noborder">
        ...
        <tr class="noborder">
          ...
          <input type="radio" name="mobile_host_type" value="3" />
          一信通
          </label>
          <?php }else if($output['list_setting']['mobile_host_type']==2){ ?>
          ...
          <input type="radio" name="mobile_host_type" value="3" checked="checked" />
          一信通
          </label>
          <?php }?>
          ...
          <td class="vatop tips"><label class="field_notice">三选一</label></td>
        </tr>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><label class="field_notice"> 	可选填写<a href="http://api.smsbao.com/" target="_blank">短信宝</a>或
                  <a href="http://www.yunpian.com/" target="_blank">云片短信</a>或<a href="http://www.ums86.com">一信通</a></label></td>
        </tr>
        <tr>
          <td colspan="2" class="required">企业编号:</td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['list_setting']['mobile_spcode'];?>" name="mobile_spcode" id="mobile_spcode" class="txt"></td>
          <td class="vatop tips"><label class="field_notice">一信通时使用</label></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><label class="field_notice">如： 商城</label></td>
        </tr>
