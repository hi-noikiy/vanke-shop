  ...
  <form method="post" name="settingForm" id="settingForm">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="space">
            <th colspan="16">商城配置:</th>
        </tr>
        <tr class="noborder">
            <td colspan="2" class="required"><label>店铺经营类目绑定:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform onoff"><label for="store_class_bind_isuse_1" class="cb-enable <?php if($output['list_setting']['store_class_bind_isuse'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['open'];?>"><span><?php echo $lang['open'];?></span></label>
                <label for="store_class_bind_isuse_0" class="cb-disable <?php if($output['list_setting']['store_class_bind_isuse'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['close'];?>"><span><?php echo $lang['close'];?></span></label>
                <input type="radio" id="store_class_bind_isuse_1" name="store_class_bind_isuse" value="1" <?php echo $output['list_setting']['store_class_bind_isuse'] ==1?'checked=checked':''; ?>>
                <input type="radio" id="store_class_bind_isuse_0" name="store_class_bind_isuse" value="0" <?php echo $output['list_setting']['store_class_bind_isuse'] ==0?'checked=checked':''; ?>>
            <td class="vatop tips">开启后,店铺的经营类目将直接与店铺分类绑定</td>
        </tr>
