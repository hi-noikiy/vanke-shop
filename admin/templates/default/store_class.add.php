  ...
  <form id="store_class_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="0" name="sc_bail" id="sc_bail" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" class="required"><label for="gc_bind">商城分类绑定:</label></td>
        </tr>
        <tr class="noborder">
            <td class="vatop rowform"><input type="text" value="<?php echo $output['class_array']['gc_bind'];?>" name="gc_bind" id="gc_bind" class="txt"></td>
            <td class="vatop tips">请填写商城分类的编号</td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
