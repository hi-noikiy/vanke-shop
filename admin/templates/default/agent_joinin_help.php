...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>代理首页</h3>
      <ul class="tab-base">
        <li><a href="index.php?act=agent_joinin&op=setting" ><span><?php echo '设置';?></span></a></li>
        <li><a href="index.php?act=agent_joinin&op=edit_info"><span><?php echo '前台加盟页';?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo '流程说明';?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w150 align-center"><a href="index.php?act=agent_joinin&op=edit_help&help_id=<?php echo $val['help_id'];?>"><?php echo $lang['nc_edit'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
