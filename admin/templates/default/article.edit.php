  ...
  <form id="article_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><?php echo $lang['nc_summary'];?>: 
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['article_array']['article_summary'];?>" style="width:650px;" value="255" name="article_summary" id="article_summary" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" class="required"><?php echo $lang['article_add_upload'];?>(图片尺寸243x127)::</td>
        </tr>
        <tr class="noborder">
