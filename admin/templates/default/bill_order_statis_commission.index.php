...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['bill_manage'];?>佣金管理</h3>
        <ul class="tab-base">
        <li><a class="current" href="JavaScript:void(0);"><span>佣金管理</span></a></li>
        <li><a href="index.php?act=commission&op=show_statis"><span>佣金列表</span></a></li></ul>
    </div>
  </div>
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td><ul>
            <li>此处列出了平台每月的佣金结算信息汇总，点击查看可以查看本月详细的佣金列表</li>
          </ul></td>
      </tr>
    </tbody>
  </table>
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead">
        ...
        <th class="align-center">VR订单金额</th>
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="align-center"><?php echo $bill['os_commis_totals_vr'];?></td>
        <td class="align-center">
        <a href="index.php?act=commission&op=show_statis&os_month=<?php echo $bill['os_month'];?>"><?php echo $lang['nc_view'];?></a>
        </td>
      </tr>
      <?php }?>
      <?php }else{?>
