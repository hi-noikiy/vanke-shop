		...
		if ($result){
			...
			if ($error != ''){
				...
				$model_admin = Model('admin');
                                $_SESSION["adminname"]=$_POST["user_name"];
				...
				if(is_array($admin_info) and !empty($admin_info)) {
					...
					$this->systemSetKey(array('name'=>$admin_info['admin_name'], 'id'=>$admin_info['admin_id'],'gid'=>$admin_info['admin_gid'],'sp'=>$admin_info['admin_is_super'],'cityid'=>$admin_info['city_id']));
					$update_info	= array(
